 ...
 * 
 */
@WebServiceClient(name = "EntregaWSService", targetNamespace = "http://webservices/", wsdlLocation = "http://localhost:8080/lab134155/EntregaWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ENTREGAWSSERVICE_QNAME = new QName("http://webservices/", "EntregaWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/lab134155/EntregaWS?wsdl");
    ...
    public EntregaWS getEntregaWSPort() {
        return super.getPort(new QName("http://webservices/", "EntregaWSPort"), EntregaWS.class);
    }
    ...
    public EntregaWS getEntregaWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices/", "EntregaWSPort"), EntregaWS.class, features);
    }
